...
If live GitHub disagrees with Drive volatile controller state, treat the disagreement as a control-plane defect. Use live GitHub as provisional construction truth, preserve the conflict, and reconcile the volatile Drive row. Never overwrite accepted product scope with PR/CI facts.
