...
REPAIR_INCREMENT = "INCIDENT-REPAIR-EXACT-PATH-TEST-01"
    ...
    state.update(
        {
            ...
            "wake_condition": "Exact-path test repair is active.",
            "next_admissible_action": "Complete only the exact-path test repair.",
